...
<div id="general_box">
  ...
  <div id="Navigation"><center><h3>Список всех студентов</h3></center></div>
  ...
  <div id="Content">
    <h3>Вас приветствует информационная система. Ниже выведены списки студентов и списки групп. Для редактирования обратитесь в меню с левой стороны.</h3>
    <table id="myTable">
