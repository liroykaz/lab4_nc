...
<div id="general_box">
    ...
    <div id="Navigation"><center><h3>Редактирование студентов</h3></center></div>
    ...
    <div id="Form_1">
        <h3>Чтобы изменить студента выберите ID и введите новые данные в форму ниже.</h3>
        <form action="/redact-student-page" method="Post">
            <table align="center">
