...
<div id="general_box">
    ...
    <div id="Form_1">
        <h3>Чтобы удалить студента выберите ID и нажмите кнопку.</h3>
        <form action="/delete-student-page" method="Post">
            <table align="center">
                <tr><th colspan="3" align="center">Удаление студента</th></tr>
                <tr><td align="right">ID</td><td align ="left"><input type = "text" name="id_of_student"/></td></tr>
                <tr><td></td><td colspan="1" align="center"><input type="submit" name="add_button" value="Удалить"/></td><td></td></tr>
            </table>
        </form>
    </div>
